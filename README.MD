...
## 项目简介
#### Demo: [https://mosaict.deno.dev/](https://mosaict.deno.dev/)
...
5. 在项目设置中添加环境变量 GEMINI_API_KEY={你的API Key}
...
MIT License : https://github.com/tech-shrimp/gemini-playground/blob/main/LICENSE
```
